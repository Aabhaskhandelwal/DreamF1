...
export default function TelemetryClient({
  ...
  useEffect(() => {
    ...
    const base = `${process.env.NEXT_PUBLIC_API_URL ?? ""}/api/telemetry/2026/${roundNum}`
